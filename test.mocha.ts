...
SystemProgram.createAccount({
            fromPubkey: provider.publicKey,
            newAccountPubkey: Token B.publicKey,
            lamports,
            space: MINT_SIZE,
...
createInitializeMint2Instruction(token_b.publicKey, 6, provider.publicKey, null),
createInitializeMint2Instruction(token_a.publicKey, 6, provider.publicKey, null),
createAssociatedTokenAccountIdempotentInstruction(maker_ata_a.publicKey, maker.publicKey, token_a.publicKey, 1000000000),
createAssociatedTokenAccountIdempotentInstruction(taker_ata_b.publicKey, taker.publicKey, token_b.publicKey, 1000000000),
createAssociatedTokenAccountIdempotentInstruction(maker_ata_b.publicKey, maker.publicKey, token_b.publicKey, 0),
createAssociatedTokenAccountIdempotentInstruction(taker_ata_a.publicKey, taker.publicKey, token_a.publicKey, 0),
createMintToInstruction(maker_ata_a.publicKey, maker.publicKey, token_a.publicKey, 1000000000, 1000000000),
createMintToInstruction(taker_ata_b.publicKey, taker.publicKey, token_b.publicKey, 1000000000, 1000000000),
createMintToInstruction(maker_ata_b.publicKey, maker.publicKey, token_b.publicKey, 0, 0),
createMintToInstruction(taker_ata_a.publicKey, taker.publicKey, token_a.publicKey, 0, 0)
        ];
